...
public class SimplifiedComparison
{
    ...
    // ============= HeroCsv (Our Implementation) =============

    [Benchmark(Baseline = true)]
    [BenchmarkCategory("HeroCsv")]
    public int HeroCsv_String()
    {
        var records = global::HeroCsv.Csv.ReadAllRecords(_testCsv);
        return records.Count;
    }

    [Benchmark]
    [BenchmarkCategory("HeroCsv")]
    public int HeroCsv_Memory()
    {
        var records = global::HeroCsv.Csv.ReadAllRecords(_testMemory);
        return records.Count;
    }
    ...
    {
        return global::HeroCsv.Csv.CountRecords(_testCsv);
    }

    [Benchmark]
    [BenchmarkCategory("HeroCsv")]
    public int HeroCsv_Memory_CountOnly()
    {
        return global::HeroCsv.Csv.CountRecords(_testMemory);
    }
