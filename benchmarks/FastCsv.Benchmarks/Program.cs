...
public class Program
{
    ...
    {
        var rootCommand = new RootCommand("FastCsv Benchmark Suite - High-performance CSV parsing benchmarks");
        ...
        var directCompareCommand = new Command("direct", "Direct FastCsv vs Sep comparison");
        ...
        var internalPerfCommand = new Command("internal", "Internal FastCsv performance benchmarks");
