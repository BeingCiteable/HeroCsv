...
public class ZeroAllocationTests
{
    ...
    private static CsvOptions NoHeaderOptions => new CsvOptions(',', '"', false);
    
    // Helper to create options with header = true (default)
    private static CsvOptions WithHeaderOptions => CsvOptions.Default;
    [Fact]
