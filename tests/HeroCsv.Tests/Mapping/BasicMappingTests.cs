...
public class BasicMappingTests
{
    ...
    [Fact]
    public void CsvMapper_InvalidTypeConversion_UsesDefaultValue()
    {
        var mapper = new CsvMapper<TestPerson>(CsvOptions.Default);
        ...
        // The mapper uses default values on invalid conversion
        var person = mapper.MapRecord(record);
        Assert.Equal("Invalid", person.Name);
